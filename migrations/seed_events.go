...
func seedEvents(db *gorm.DB) {
	...
	eventSeeds := []struct {
		...
		{"Seminar Budaya Nusantara 2026", "Seminar inspiratif tentang kekayaan budaya Nusantara.", "Sesi edukatif tentang kekayaan budaya Nusantara.", "Gedung Kesenian Malang", "Jl. Soekarno Hatta No. 1, Malang", "https://maps.google.com/?q=Gedung+Kesenian+Malang", time.Date(2026, time.March, 21, 9, 0, 0, 0, time.UTC), time.Date(2026, time.March, 21, 12, 0, 0, 0, time.UTC), time.Date(2026, time.March, 20, 23, 59, 0, 0, time.UTC), true, 75000, 300, 0, "published"},
		{"Workshop Batik Modern", "Workshop praktis membuat motif batik modern.", "Praktik langsung membuat motif batik modern.", "Balai Kreatif Malang", "Jl. Ijen No. 12, Malang", "https://maps.google.com/?q=Balai+Kreatif+Malang", time.Date(2026, time.March, 22, 13, 0, 0, 0, time.UTC), time.Date(2026, time.March, 22, 16, 0, 0, 0, time.UTC), time.Date(2026, time.March, 21, 23, 59, 0, 0, time.UTC), true, 100000, 120, 0, "published"},
		...
		{"Exhibition Karya UMKM", "Pameran karya dan produk unggulan UMKM lokal.", "Pameran karya kreatif dan produk UMKM lokal.", "Malang Creative Center", "Jl. A. Yani No. 53, Malang", "https://maps.google.com/?q=Malang+Creative+Center", time.Date(2026, time.March, 27, 10, 0, 0, 0, time.UTC), time.Date(2026, time.March, 27, 19, 0, 0, 0, time.UTC), time.Date(2026, time.March, 26, 23, 59, 0, 0, time.UTC), false, 0, 800, 0, "published"},
		...
		{"Workshop Fotografi Event", "Belajar teknik foto untuk dokumentasi event budaya.", "Pelatihan teknik fotografi untuk dokumentasi event budaya.", "Studio Kreatif Arema", "Jl. Bandung No. 9, Malang", "https://maps.google.com/?q=Studio+Kreatif+Arema", time.Date(2026, time.March, 30, 13, 0, 0, 0, time.UTC), time.Date(2026, time.March, 30, 17, 0, 0, 0, time.UTC), time.Date(2026, time.March, 29, 23, 59, 0, 0, time.UTC), true, 65000, 180, 0, "published"},
	}
